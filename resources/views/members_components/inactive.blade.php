...
<body style="background:#F3F4F6;">
    <div style="min-height:100vh; display:flex; align-items:center; justify-content:center; padding:2rem;">
        <div style="background:#fff; border-radius:16px; box-shadow:0 1px 3px rgba(0,0,0,.06), 0 1px 2px rgba(0,0,0,.04); border:1px solid #E2E8E5; max-width:520px; width:100%; overflow:hidden;">
            <div style="padding:2rem 2rem 1.5rem; text-align:center; border-bottom:1px solid #E2E8E5;">
                ...
                <p style="font-size:.9rem; color:#6B7280; margin:0; line-height:1.55;">
                    Hello, {{ $user->first_name ?? '' }} {{ $user->last_name ?? '' }}. Your membership is currently inactive.
                </p>
            </div>
                    ...
                    <div style="display:flex; align-items:center; justify-content:space-between;">
                        <div>
                            ...
                            @if($scAccount && (float) $scBalance['amount'] > 0)
                                ...
                                <p style="font-size:.75rem; color:#6B7280; margin:.15rem 0 0;">{{ number_format((float) $scBalance['shares']) }} share{{ (float) $scBalance['shares'] == 1 ? '' : 's' }} retained</p>
                            @else
